...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mag2exp-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14023&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mag2exp-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mag2exp` can be installed with:

```
conda install mag2exp
```

It is possible to list all of the versions of `mag2exp` available on your platform with:
